...
#include "zen_utils/parameters/ZenBoolParameter.h"
#include <zen_utils/parameters/ZenIntParameter.h>
	...
	public AsyncUpdater
{
	...
	virtual void setNewUnnormalisedValue(float newUnnormalisedValue)
	{
