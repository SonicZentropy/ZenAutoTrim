...
//
//  Details: Derived from juce Singletons, returns shared pointer to
//  instance rather than basic pointer.
//
//  Zentropia is hosted on Github at [https://github.com/SonicZentropy]
===============================================================================*/


#ifndef ZEN_SINGLETON_H_INCLUDED
#define ZEN_SINGLETON_H_INCLUDED
...
To use this, add the line Zen_DeclareSingleton (MyClass, doNotRecreateAfterDeletion)
to the class's definition.

Then put a macro Zen_ImplementSingleton (MyClass) along with the class's
implementation code.
...
Clients can then call the static method MyClass::getInstance() to get a shared pointer
...
Zen_DeclareSingleton (MySingleton, false)
};

Zen_ImplementSingleton (MySingleton)


// example of usage:
std::shared_ptr<MySingleton> m = MySingleton::getInstance(); // creates the singleton if there isn't already one.
...
*/
#define Zen_DeclareSingleton(classname, doNotRecreateAfterDeletion) \
\
