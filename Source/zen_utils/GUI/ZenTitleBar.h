...
public:
	...
	void init();
	void addBypassListener(Listener* theListener);
	~ZenTitleBar();
	...
	Button* getBypassBtn() const { return bypassBtn; }
	

protected:
	Image backgroundImg;
	Image titleTextImage;
	Image bypassOnImg, bypassOffImg;
	ScopedPointer<ImageButton> bypassBtn;
	
	//ZenBypassButton bypassButton;
