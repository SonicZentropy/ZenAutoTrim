...
//
//  Details: Allows generic buffers to be visualized in a window
//
...
class DataSnapshot : public ReferenceCountedObject
{
public:
...
{
public:
	explicit BufferVisualiser(const String& bufferVisName = "BufferVisualiserWindow")
		:
