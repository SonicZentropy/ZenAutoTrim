...
#include "zen_utils/components/ZenRotaryEditorLabel.h"
#include "zen_utils/GUI/ZenLookAndFeel.h"

using std::make_shared;


ZenRotaryFilmStripSlider::ZenRotaryFilmStripSlider(const String& imgName, const TextEntryBoxPosition inPos,
	const int inTextBoxWidth, const int inTextBoxHeight,
	const int numFrames, const int inKnobWidth, const int inKnobHeight,
...
void ZenRotaryFilmStripSlider::setSize(int newWidth, int newHeight)
{
	...
	int numPlaces = this->getNumDecimalPlacesToDisplay();
...
void ZenRotaryFilmStripSlider::setSkewFactorFromMidPoint(const double midValue)
{
	midPoint = midValue;
	DBG("Setting rotary midpoint to: " << midValue);
	Slider::setSkewFactorFromMidPoint(midValue);	
}

// String ZenRotaryFilmStripSlider::getTextFromValue(double value)
// {
// 	DBG("In ZenRotaryFilmStripSlider::getTextFromValue(value) with num decimal: " << getNumDecimalPlacesToDisplay());
