...
#include "zen_utils/components/ZenRotaryFilmStripSlider.h"
...
{
public:
	ZenRotaryEditorLabel(String inName, bool inTextHasShadow = false, int inTextDecimalPrecision = 2);
	...
	void setTextDecimalPrecision(int inPrecision) { textDecimalPrecision = inPrecision; }
	int getTextDecimalPrecision() const { return textDecimalPrecision; }

	void setText(const String& newText,
		NotificationType notification) override;

protected:
	bool textHasShadow;
	int textDecimalPrecision;
	ZenRotaryFilmStripSlider::TextEntryBoxPosition textPos;
