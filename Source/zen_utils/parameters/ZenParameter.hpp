...
//Requires changes to juce_AudioProcessorParameter.h:


namespace Zen {
using namespace juce;
class ZenParameter : public juce::AudioProcessorParameter, public ReferenceCountedObject, public ValueListener
{
...
public:
	...
	{
//		DBG("In ZenParameter::ZenParameter() ");
...
//		DBG("In ZenParameter::setValue() ");
	...
	{
		DBG("In ZenParameter::setValueNotifyingHost() calling processor->setparamNotifyingHost with inValue: " + String(inValue));
		// This method can't be used until the parameter has been attached to a processor!
		jassert(processor != nullptr && getParameterIndex() >= 0);
		ZEN_LABEL_TRACE("Zen Param value: ", String(getValue()));
...
#pragma region Getters/Setters
	...
	virtual float getValueForGUIComponent()
	{
		return getValue();
	}
